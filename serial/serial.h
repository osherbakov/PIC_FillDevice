...
#define HQII_BAUDRATE	(1666)
#define HQII_PERIOD_US		(600)
#define HQII_HALFPERIOD_US	(300)
#define HQII_QTRPERIOD_US	(150)
#define HQII_DELAY_EDGE_US 	(HQII_HALFPERIOD_US + HQII_QTRPERIOD_US - 4)
